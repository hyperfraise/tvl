FROM nvcr.io/nvidia/cuda:11.1.1-devel-ubuntu20.04 as ffmpeg-builder
...
FROM nvcr.io/nvidia/cuda:11.1.1-devel-ubuntu20.04 as tvl-builder
...
RUN pip3 install --upgrade cupy-cuda111
